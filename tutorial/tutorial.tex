...
\begin{frame}[label={sec:org0bce690}]{Exercise 6: Write, fit, and diagnose a hierarchical two}
...
%\end{frame}
%
%\begin{frame}[label={sec:org2eb8338}]{ODE system of F-K model}
...
%\end{itemize}
%\end{frame}
%\begin{frame}[fragile,label={sec:orgb5bf813}]{Coupled PK-PD system}
...
%\end{frame}
%
%\begin{frame}[fragile,label={sec:org0170c47}]{Coupled PK-PD system}
% \begin{minted}[breaklines=true,fontsize=\footnotesize,breakanywhere=true]{stan}
%real[] pmx_solve_twocpt_rk45(reduced_ODE_system, int nOde, real[] time, real[] amt, real[] rate, real[] ii, int[] evid, int[] cmt, real[] addl, int[] ss, real[] theta, real[] biovar, real[] tlag, real rel_tol, real abs_tol, real max_step)
%\end{minted}
%\begin{itemize}
