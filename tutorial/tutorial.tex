...
\label{sec:orgce26dec}
\begin{frame}[label={sec:org3b4ae29}]{}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org506524a}]{Outline}
\begin{block}{Day 1}
\begin{itemize}
...
\begin{frame}[label={sec:org72ff91b}]{Preliminary question}
\begin{itemize}
...
\begin{frame}[label={sec:org2574de9}]{Modeling framework}
...
\begin{frame}[label={sec:org142b07f}]{Inference}
\begin{itemize}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orga0bfeff}]{Diagnosing the inference algorithm}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org560b740}]{Example: fitting a linear model}
Likelihood:
\begin{align*}
...
\begin{frame}[label={sec:org8c4151e}]{Example 2: Bone mineral density model from \cite{Peterson:2012}}
\begin{latex}
\begin{center}
...
\begin{frame}[label={sec:org4c9c4ee}]{Two compartment model}
...
\begin{frame}[label={sec:org3491103}]{The event schedule}
An event can be:
\begin{itemize}
...
\begin{frame}[label={sec:org6a082f1}]{Drug concentration in a patient's blood}
\begin{latex}
\begin{center}
...
\begin{frame}[label={sec:orge32ff95}]{The event schedule}
\begin{itemize}
...
\begin{frame}[label={sec:orgd1d3d7a}]{Torsten functions}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:orgdd361df}]{Torsten functions}
...
\begin{frame}[label={sec:org003fad1}]{Example}
...
\begin{frame}[label={sec:org90a7d73}]{Example}
\begin{block}{Model}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[fragile,label={sec:org09afdf4}]{Example}
 \begin{block}{Prior}
\begin{minted}[breaklines=true,fontsize=\footnotesize,breakanywhere=true]{stan}
...
\begin{frame}[fragile,label={sec:orgc4f5daf}]{Numerical integrators}
 \begin{center}
\begin{tabular}{lll}
...
\begin{frame}[fragile,label={sec:org1c3ad50}]{Exercise}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org2a5bac2}]{Exercise}
...
\begin{frame}[fragile,label={sec:org58071cd}]{Exercise}
 How to build \& run?
...
\begin{frame}[fragile,label={sec:orga37dec9}]{ODE group integrators}
 \begin{columns}
\begin{column}{0.45\columnwidth}
\begin{block}{Single ODE system}
\begin{minted}[breaklines=true,fontsize=\footnotesize,breakanywhere=true]{stan}
...
\begin{frame}[fragile,label={sec:org41a5290}]{PMX population solvers}
 \begin{center}
\begin{tabular}{ll}
Single ODE system & ODE group\\
\hline
...
\begin{frame}[fragile,label={sec:org3d184fa}]{PMX population solvers}
 \begin{minted}[breaklines=true,fontsize=\footnotesize,breakanywhere=true]{stan}
matrix
...
\begin{frame}[label={sec:orgbc7159f}]{Exercise}
...
\begin{frame}[label={sec:org74a3493}]{Exercise}
...
\begin{frame}[label={sec:org4dda62a}]{Exercise}
